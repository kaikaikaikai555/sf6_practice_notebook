...
| ログイン画面 | トップ画面 |
| :---: | :---: |
| <img src="https://github.com/user-attachments/assets/81b7fd85-8dba-4827-9a0d-fe6c72181df6" width="100%"> | <img src="https://github.com/user-attachments/assets/e2d33d34-b785-425b-aeff-6340504d4ae1" width="100%"> |
| 登録せずにサービスをお試しいただけるゲストログイン機能などを実装しています。 | アプリのコンセプトや概要をひと目で伝えるトップ画面です。 |

| 1. 10秒反省機能（入力フォーム） | 2. 10秒反省の敗因タグ機能 |
| :---: | :---: |
| <img src="https://github.com/user-attachments/assets/f2730f11-0c8b-4edb-b9e1-9e810330864c" width="100%" style="max-height: 300px; object-fit: contain;"> | <img src="https://github.com/user-attachments/assets/a1ab09ec-acb4-46b4-8e7d-fc1467655218" width="100%" style="max-height: 300px; object-fit: contain;"> |
...
| :---: | :---: |
| <img src="https://github.com/user-attachments/assets/51ae8950-423c-4fe6-829d-c0b053909f65" width="100%"> | <img src="https://github.com/user-attachments/assets/db02ae83-20bb-44fd-9b00-0425e862843b" width="100%"> |
| 登録した対戦ログや対策メモの内容を個別で確認できる詳細画面です。 | 詳細画面を開くことで、自身の敗因の傾向や詳しい分析結果を確認できます。 |

| 7. 反省、対策メモを検索してみる機能 | |
| :---: | :---: |
| <img src="https://github.com/user-attachments/assets/23a7183f-52cb-4540-8e0e-c684a9664037" width="100%"> | |
